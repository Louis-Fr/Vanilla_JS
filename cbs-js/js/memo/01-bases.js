...
// il est même possible de ne rien mettre dans la chaîne : on parle de chaîne vide.
console.log('')
console.log()

// CONCATENATION
console.log('concat' + 'ténation')

// CONVERSION OU CAST
console.log('chaîne' + 1)
console.log('chaîne' + '1')
...
// ARGUMENTS
console.log(2,4, 7) // plusieurs arguments de type Number
console.log('plusieurs arguments dans console.log()', 0,0,7)
...
// Les noms de variable peuvent contenir des majuscules, des chiffres, et des caractères accentués.
// une variable ne peut PAS commencer par un chiffre
// let 10MentionWeb // ERREUR car commence par un chiffre
...
// Il existe unek autre façon de nommer les variables non utilisées en JS qui est snake case : les mots sont séparés pas des tirets du 8
...
// INCRÉMENTATION
// incrémentation une addition avec le nom de la variable
ennemi = ennemi + 2
...
// incrémentation avec nomDeLaVariable++ = +1
console.log(nbDeVie);   
